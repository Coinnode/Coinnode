...
#define START_MASTERNODE_PAYMENTS_TESTNET 1516766450 // Wednesday, 24 de January de 2018 4:00:50 GMT
#define START_MASTERNODE_PAYMENTS 1516766450 // Wednesday, 24 de January de 2018 4:00:50 GMT

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 6 * COIN; //Constant reward of 8 CNE per COIN i.e. 8%
