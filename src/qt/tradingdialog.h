...
private slots:
    ...
    QString BuyCNE(QString OrderType, double Quantity, double Rate);
    QString SellCNE(QString OrderType, double Quantity, double Rate);
