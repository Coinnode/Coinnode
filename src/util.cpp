...
int nAnonymizeCoinnodeAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Coinnode
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Coinnode
    // Mac: ~/Library/Application Support/Coinnode
    // Unix: ~/.Coinnode
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Coinnode";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Coinnode.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Coinnoded.pid"));
