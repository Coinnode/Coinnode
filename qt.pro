...
win32:LIBPNG_INCLUDE_PATH=C:/deps/libpng-1.6.16
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH=C:/deps/db-4.8.30.NC/include
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /usr/local/Cellar/boost/1.59.0/lib
    windows:BOOST_LIB_PATH=C:/deps/boost_1_57_0/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/Cellar/boost/1.59.0/include
    windows:BOOST_INCLUDE_PATH=C:/deps/boost_1_57_0/include
}
...
macx:ICON = src/qt/res/icons/Coinnode.icns
macx:TARGET = "Coinnode-Qt"
